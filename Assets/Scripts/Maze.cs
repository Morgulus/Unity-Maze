...
public class Maze : MonoBehaviour {
    ...
    private void NextGenerationStep(List<MazeCell> active)
    {
        ...
        MazeDirections direction = currentCell.RandomUninitializedDirection;
    ...
    private void CreatePassage(MazeCell cell, MazeCell otherCell, MazeDirections direction)
    {
    ...
    private void CreateWall(MazeCell cell, MazeCell otherCell, MazeDirections direction)
    {
